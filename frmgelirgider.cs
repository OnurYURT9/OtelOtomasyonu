...
namespace Otel_Uygulaması
{
    public partial class frmgelirgider : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if(textBox1.Text =="")
            {
                MessageBox.Show("Textboxları boş geçmeyin");
            }
            else
            {
            int personel;
        ...
        private void frmgelirgider_Load(object sender, EventArgs e)
        {
            ...
            //Gıdaların giderleri
            baglanti.Open();
            SqlCommand komut2 = new SqlCommand("select sum(Temel_Gıda) as toplam1 from Alinan", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut3 = new SqlCommand("select sum(İçecek) as toplam2 from Alinan", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut4 = new SqlCommand("select sum(Atıştırmalık) as toplam3 from Alinan", baglanti);
