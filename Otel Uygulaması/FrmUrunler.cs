...
namespace Otel_Uygulaması
{
    public partial class FrmUrunler : Form
    {
        ...
        private void btnkaydet_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Urunler(Temel_Gıda,İçecek,Atıştırmalık) values ('" + txtgidalar.Text + "','" + txtiçecek.Text + "','" + txtatistirmalik.Text + "')", baglanti);
